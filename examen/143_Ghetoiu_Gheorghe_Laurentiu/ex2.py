...
def turingMachine(input_string):
    ...
    while currentStateF != q_acc[0] and currentStateS != q_acc[0]:
        ...
        try:
            ...
            if tranzitii[currentArgumentF][3] == 'R':
                ...
                if twoTapesInOne[currentPositionF-1] != '$':
                    currentPositionF -= 1
            ...
            if tranzitii[currentArgumentS][4] == 'R':
                ...
                if twoTapesInOne[currentPositionS-1] != '$':
                    currentPositionS -= 1
    ...
    if tapeModified == True:
        ...
        if validF == True:
            print("Inputul initial este valid")
        else:
            print("Inputul initial este invalid")
        if validS == True:
            print("Inputul de backup este valid")
        else:
            print("Inputul de backup este invalid")
    else:
